...
`,label:"type-wa"},"-"],selectedCurrency:"₽",students:[],groups:[{id:1,name:"ЕГЭ",students_count:10,rate:"2000 ₽ / 1,5 часа",balance:1200,homework:"Ждёт ответа",comment:"Работаем по скидке 20% (для всех)",students:[{id:1,name:"Алексей"}]},{id:2,name:"ОГЭ",students_count:10,rate:"2000 ₽ / 1,5 часа",balance:1200,homework:"Ждёт ответа",comment:"Работаем по скидке 20% (для всех)",students:[{id:2,name:"Тимур"}]}],studentAnalytics:null}),getters:{},actions:{async getStudents(){if(!this.students.length){const e=await i();this.students=e}},async setStudentAnalytics(){const t=s().params.id;console.log(t),t&&this.studentAnalytics===null&&(this.studentAnalytics=await a(t))}}});export{d as u};
