  ...
  <v-base>
    <section class="v-finance">
      ...
      <div class="v-finance__menu" v-click-outside="() => buttonsActive = false">
        ...
        <div class="v-finance__menu-items" :class="{ active: buttonsActive }">
          <button class="v-finance__menu-item" @click="() => toggleModal('income')">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
          ...
          <button class="v-finance__menu-item" @click="() => toggleModal('expense')">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
