<template>
  <div class="v-profile-info-right">
    <div class="v-profile-info-right__section styled-section">
      ...
      <button class="custom-btn white" @click="() => toggleModal('linkEmail')">
        Привязать другую почту
      </button>
    </div>
    <div class="v-profile-info-right__section styled-section" @click="toggleModal('changePassword')">
      <button class="v-profile-info-right__button">
