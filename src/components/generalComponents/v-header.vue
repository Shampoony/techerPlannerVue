      ...
      <nav class="v-header__nav">
        ...
        <ul class="v-header__list">
          <li class="v-header__list-item">
            <a class="v-header__list-item-link" href="">Главная</a>
          </li>
          <li class="v-header__list-item">
            <a class="v-header__list-item-link" href="">Ученики</a>
          </li>
          <li class="v-header__list-item">
            <a class="v-header__list-item-link active" href="">Календарь</a>
          </li>
          <li class="v-header__list-item">
            <a class="v-header__list-item-link" href="">Финансы</a>
          </li>
          <li class="v-header__list-item">
            <a class="v-header__list-item-link" href="">Аналитика</a>
          </li>

          <li class="v-header__list-item">
            <a class="v-header__list-item-link" href="">Анонсы</a>
          </li>
        </ul>
      ...
      <div class="modal-burger top">
        ...
        <ul class="modal-burger__list">
          <li class="modal-burger__list-item">
            <a class="modal-burger__list-item-link active" href="">Главная</a>
          </li>
          <li class="modal-burger__list-item">
            <a class="modal-burger__list-item-link" href="">Ученики</a>
          </li>
          <li class="modal-burger__list-item">
            <a class="modal-burger__list-item-link" href="">Календарь</a>
          </li>
          <li class="modal-burger__list-item">
            <a class="modal-burger__list-item-link" href="">Финансы</a>
          </li>
          <li class="modal-burger__list-item">
            <a class="modal-burger__list-item-link" href="">Аналитика</a>
          </li>
          <li class="modal-burger__list-item">
            <a class="modal-burger__list-item-link" href="">Анонсы</a>
          </li>
        </ul>
